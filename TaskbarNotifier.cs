...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
        ...
        protected double nIncrementOpacityShow;
        protected double nIncrementOpacityHide;
        protected int nTopOffset;
        protected int nLeftOffset;
        protected int nStackPosition;
        ...
        public int StackPosition
        {
            get
            {
                return nStackPosition;
            }
            set
            {
                nStackPosition = value;
		...
		public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
		{
			...
			if (nTimeToShow > 10)
			{
                ...
                nIncrementOpacityShow = 1.0 / nEvents;
			}
			else
			{
				nShowEvents = 10;
				nIncrementShow = BackgroundBitmap.Height;
                nIncrementOpacityShow = 1;
			}
			...
			if( nTimeToHide > 10)
			{
                ...
                nIncrementOpacityHide = 1.0 / nEvents;
			}
			else
			{
				nHideEvents = 10;
				nIncrementHide = BackgroundBitmap.Height;
                nIncrementOpacityHide = 0;
			}
			...
			switch (taskbarState)
			{
				case TaskbarStates.hidden:
                    ...
                    int n = (int)WorkAreaRectangle.Height / BackgroundBitmap.Height;
                    int x,y;
                    y = StackPosition % n;
                    x = (int) StackPosition / n;
                    nTopOffset = -BackgroundBitmap.Height*y;
                    nLeftOffset = -BackgroundBitmap.Width * x;
					SetBounds(WorkAreaRectangle.Right-BackgroundBitmap.Width-17 + nLeftOffset, WorkAreaRectangle.Bottom-1 + nTopOffset, BackgroundBitmap.Width, 0);
			...
			switch (taskbarState)
			{
				case TaskbarStates.appearing:
                    if (Height < BackgroundBitmap.Height)
                    {
                        ...
                        this.Opacity += nIncrementOpacityShow;
                    }
                    else
                    {
                        timer.Stop();
				...
				case TaskbarStates.disappearing:
					...
					else 
					{
                        if (Top < WorkAreaRectangle.Bottom)
                        {
                            ...
                            this.Opacity -= nIncrementOpacityHide;
                        }
                        else
                            Hide();
					}
        ...
        private void InitializeComponent()
        {
            ...
            // TaskbarNotifier
            // 
            this.ClientSize = new System.Drawing.Size(147, 119);
